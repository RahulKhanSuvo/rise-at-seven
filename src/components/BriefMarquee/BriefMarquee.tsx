      ...
      >
        ...
        >
          {displayItems.map((item, idx) => (
            ...
            >
              <h2 className="text-7xl md:text-8xl lg:text-9xl xl:text-[11rem] font-semibold tracking-tight text-grey-900 leading-[0.9]">
                {item.text}
              </h2>
              <div className="w-[25vw] md:w-[20vw] lg:w-[15vw] xl:w-[10vw] aspect-square rounded-2xl lg:rounded-3xl overflow-hidden relative shrink-0">
                <Image
                  src={item.image}
                  alt={item.text}
                  fill
